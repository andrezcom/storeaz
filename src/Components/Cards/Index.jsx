  ...
  return (
    <div className="card">
      ...
      <div className="p-5 flex flex-col gap-3">
        ...
        <div>
          <span className="text-xl font-bold">$400.000</span>
          <div className="flex items-center gap-2 mt-1">
            <span className="text-sm line-through opacity-50">$600.000</span>
        ...
        <div className="mt-5 flex gap-2 ">
          <button className="button-prime">ADD</button>
          <button className="button-ico">@</button>
        </div>
      </div>
    </div>
  );
